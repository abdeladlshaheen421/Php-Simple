       ...
       $connection = "mysql:dbname=phptask;host=127.0.0.1;port=3306;";
        ...
        try
        {
            ...
            foreach ($allUsers as $key) {
                ...
                $tableOfUsers.="<td><a class='show' href='show.php?id=".$key["id"]."'>Show</a></td>";
                $tableOfUsers.="<td><a class='edit' href='editForm.php?id=".$key["id"]."'>Edit</a></td>";
                $tableOfUsers.="<td><a class='delete' href='delete.php?id=".$key["id"]."'>Delete</a></td>";
                $tableOfUsers.="</tr>";
            }
            $tableOfUsers.="</table>";
            echo $tableOfUsers;
